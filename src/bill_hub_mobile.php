...
<?
					...
					$sql_check="select * from hana_plan_tmp where session_key='".$_POST['param_opt_1']."' and order_type='1'";
...
?>
<script>
	location.href="../trip/complete.php?check=<?=$_POST['param_opt_1']?>";
</script>
<?
						exit;
					}
...
<script>
	...
	location.href="../trip/step05_mobile.php";
</script>
<?
            exit;
        }
