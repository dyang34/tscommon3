...
<?
					...
					$sql_check="select * from hana_plan_tmp where session_key='".$_POST['session_key']."' and order_type='2'";
...
?>
<script>
	location.href="../gift/complete.php?check=<?=$_POST['session_key']?>";
</script>
<?
						exit;
					}
