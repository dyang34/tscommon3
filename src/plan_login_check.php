...
if($search_jumin_1=="" || $search_jumin_2=="") {
...
//	$sel_q="select * from hana_plan_member where member_no='".$member_no."' and name='".$search_name."' and jumin_1='".$jumin_1."' and jumin_2='".$jumin_2."'";
	$sel_q="select * from hana_plan_member where member_no='".$member_no."' and jumin_1='".$jumin_1."' and jumin_2='".$jumin_2."'";
	...
	if($sel[no] != "") {
		...
		$_SESSION['login_check_key_name']=$sel["name"];
