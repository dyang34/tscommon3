	...
	<!-- container -->
		<div id="container">
			<h3 class="step_tit"><strong>가입내역 조회</strong></h3>
					...
					<div class="select_ds">
						...
						<div class="col-sm-2">
							<div class="select_ds pr10">
								<input type="number" oninput="maxLengthCheck(this)" name="phone1" id="phone1" placeholder="" class="onlyNumber input" maxlength="4">
				...
				<div class="select_ds" id="r_hp" style="display:none">
					<label class="ss_tit db">수신받은 인증번호를 3분 이내로 입력해 주세요<div id="demo"></div></label>
					<div class="col-sm-2">
						<div class="select_ds pr10">
							<input type="number" oninput="maxLengthCheck(this)" name="phone_c" id="phone_c" placeholder="" class="onlyNumber input" maxlength="6">
							<span class="pa_minus">-</span>
						</div>
					</div>
					<div class="btn-tc">
