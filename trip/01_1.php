<? $mNum = "2";  $sNum = "1"; ?>
<?php
include $_SERVER['DOCUMENT_ROOT'].'/resource/layout/header.php';
...
<? } ?>
							...
							<div class="step_select one">
								<div class="select_ds">
									...
									<p class="ib" style="padding:5px;">* 최대 20명까지 동시가입 가능</p>
								</div>
							</div>
						</div>
...
<?/*											<input class="input onlyNumber" name="jumin_2[]" id="m_jumin_2" placeholder="*******" type="password" maxlength="7" oninput="F_Nation_Check(this)"> */?>
										...
										<div class="col-sm-1">
											<div class="select_ds div_nation_dupl" id="f_country_show" style="display:none;">
