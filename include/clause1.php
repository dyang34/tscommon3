...
<ul class="agree">
	...
	<li>
		이 약관은 ㈜유라이프커뮤니케이션즈(이하 ‘회사’라 한다)가 운영하는 투어세이프 인터넷/모바일 홈페이지(이하 “홈페이지”라 한다.)에서 제공하는 보험토탈케어 서비스(이하 ‘서비스’라 한다)를 이용함에 있어 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
	</li>
	<li>
		<strong>제2조(정의)</strong>
	</li>
	<li class="type_number">
		① 홈페이지란 회사가 서비스를 이용자에게 제공하기 위하여 컴퓨터, 모바일 등 정보통신 설비를 이용하여 서비스를 거래할 수 있도록 설정한 가상의 영업장을 말합니다.
	</li>
	<li class="type_number">
		② 이용자란 홈페이지에 접속하여 이 약관에 따라 회사가 제공하는 서비스를 받는 고객을 말하며, 약관에 동의한 고객은 회원이 된다.
	</li>
	<li>
	...
	<li>
		<strong>제4조(서비스의 이용)</strong>
	</li>
	<li class="type_number">
		① 회사는 다음의 서비스를 제공합니다.
		<ul>
			<li>1. 보험상품에 대한 정보의 제공 및 보험 계약의 중개</li>
			<li>2. 보험료 산출서비스</li>
			<li>3. 보험 진단서비스</li>
			<li>4. 보험 추천서비스</li>
			<li>5. 보험 계약관리서비스</li>
			<li>6. 고객혜택제공</li>
			<li>7. 기타 회사가 정하는 서비스</li>
		</ul>
	</li>
	<li class="type_number">
	...
	<li>
		<strong>제8조(전자금융거래 이용 신청)</strong>
	</li>
	<li>
