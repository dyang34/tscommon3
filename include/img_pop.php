...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/tscommon/css/base.css" />
...
<body>
<p class="img_close"><a href="javascript:void(0);" onclick="history.go(-1);"><img src="/tscommon/img/common/close.png" alt=""></a></p>
