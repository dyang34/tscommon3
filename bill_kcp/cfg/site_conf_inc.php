...
/* ============================================================================== */
$g_conf_home_dir  = $root_dir."/tscommon3/bill_kcp";       // BIN 절대경로 입력 (bin전까지)
...
/* =   log 경로 지정                                                            = */
/* ============================================================================== */
$g_conf_log_path = $root_dir."/tscommon3/bill_kcp/log";
...
if (defined('_TOURSAFE_SUBSITE_G_CONF_SITE_KEY')) {
    $g_conf_site_key = _TOURSAFE_SUBSITE_G_CONF_SITE_KEY;
}
