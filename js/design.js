...
function fnc_payment() {
    var newwin = window.open('/tscommon/popup/payment.php', 'payment', 'width=600,height=650,left=100,top=0,scrollbars=yes');
    newwin.focus();
}

function fnc_payment2() {
    var newwin = window.open('/tscommon/popup/payment2.php', 'payment', 'width=600,height=650,left=100,top=0,scrollbars=yes');
    newwin.focus();
}

function fnc_terms() {
    var newwin = window.open('/tscommon/popup/terms.php', 'terms', 'width=600,height=650,left=100,top=0,scrollbars=yes');
    newwin.focus();
}

function fnc_policy() {
    var newwin = window.open('/tscommon/popup/policy.php', 'policy', 'width=600,height=650,left=100,top=0,scrollbars=yes');
    newwin.focus();
}

function fnc_email() {
    var newwin = window.open('/tscommon/popup/email.php', 'email', 'width=600,height=650,left=100,top=0,scrollbars=yes');
    newwin.focus();
}
...
$(document).ready(function () {
    if (isMobile.any()!= null || isMobile.Android()!= null || isMobile.iOS()!= null) {
			$(".m_img img").click(function(){
				...
				window.location.href = '/tscommon/include/img_pop.php?type='+imgSrc+'';
