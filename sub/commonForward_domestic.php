...
*/?>					
	...
	<div class="Visual-wrap">
		<h2>국내여행자보험</h2>
		<h3>즐겁운 국내여행, 사고 질병 도난도 더욱 안심할 수 있게!</h3>
		<img src="images/sub_images_korea_travel.png">
	</div>
	<!-- /* Visual Area **************/ -->
	...
	<div id="tabMenu-wrap">
		<ul>
			...
			<li>
				<a onclick="go_page('1');" class="subNavBtn extLink end" ><span class="icon4"></span>보험료 계산/가입</a>
			</li>
		</ul>
	</div>
	<!-- /* Contents Menu Area **************/ -->
    ...
    <section>
        <div class="inner">
			...
			<table class="table-basic">
				...
				<tbody>
					<tr>
						<td>국내여행중 상해사망후유장해</td>
						<td class="txt-L">국내여행 중 급격하고도 우연한 외래의 사고로 피보험자가 사망하거나 후유장해가 발생하였을 경우, 사망시에는 가입금액 전액, 후유장해시에는 약관상의 후유장해지급율표에 따라 가입금액의 3%~100%를 지급</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="table-basic">
				...
				<tbody>
					<tr>
						<td>국내여행중 질병사망 및 질병 80%이상 후유장해</td>
						<td class="txt-L">
							국내여행도중 질병으로 보험기간 중 또는 보험기간종료후 30일 이내 에 사망하거나 약관에서 정한 80%이상 후유장해가 남았을 경우 가 입금액 전액 보상
						</td>
					</tr>
					<tr>
						<td>국내여행중 배상책임 (자기부담금 1만원)</td>
						<td class="txt-L">
							국내여행도중 타인의 신체나 재물에 손해를 가하여 법률상 배상책임 을 부담하는 경우 보상한도액내에서 보상 (자기부담금 1만원)
						</td>
					</tr>
					<tr>
						<td>국내여행중 휴대품손해 (분실제외, 자기부담금 1만원, 이동통신단말기 보상제외)</td>
						<td class="txt-L">
							국내여행도중 우연한 사고에 의하여 발생한 피보험자가 휴대하여 소유, 사용, 관리하는 휴대품에 발생한 손해를 1개 또는 1조, 1쌍에 대해 20만원한도로 보상(단, 이동통신단말기(공단말기 포함)은 보상하지 않음) (자기부담금 1만원)
						</td>
					</tr>
					<tr>
						<td>국내여행 골절(치아파절제외) 진단비(동일사고당 1회한)</td>
						<td class="txt-L">
							국내여행 도중에 상해의 직접결과로써 약관에 정한 골절(치아파절 제외)로 진단 확정된 경우 보험가입금액 지급. 단, 동일한 사고로 인하여 2가지 이상의 골절상태가 된 경우에는 1회에 한하여 보상
						</td>
					</tr>
					<tr>
						<td>국내여행 화상진단비 (동일사고당 1회한)</td>
						<td class="txt-L">
							국내여행 도중에 상해의 직접결과로써 약관에 정한 화상에 해당하고 심재성 2도 이상 화상으로 진단 확정된 경우 보험가입금액 지급. 단, 동일한 사고로 인하여 2가지 이상의 화상상태가 된 경우에는 1회에 한하여 보상
						</td>
					</tr>
					<tr>
						<td>국내여행 상해응급실내원(응급)치료비</td>
						<td class="txt-L">
							국내여행 중에 상해로 인한 “응급환자”로 응급실에 내원하여 진료를 받은 경우 보험가입금액 지급
						</td>
					</tr>
					<tr>
						<td>국내여행 상해응급실내원(비응급)치료비</td>
						<td class="txt-L">
							국내여행 중에 “응급환자”에 해당하지 않으나 상해로 인하여 응급실에 내원하여 진료를 받은 경우 보험가입금액 지급
						</td>
					</tr>
					<tr>
						<td>국내여행 상해입원일당 (4일이상 30일 한도)</td>
						<td class="txt-L">
							국내여행 도중에 상해를 입고 그 직접결과로써 병원 또는 의원(한방병원 또는 한의원 포함)에 4일 이상 입원하여 의사의 치료를 받은 경우 3일 초과 입원 1일당 보험가입금액 지급(30일 한도)
						</td>
					</tr>
					<tr>
						<td>국내여행 골절수술비 (동일사고당 1회한)</td>
						<td class="txt-L">
							국내여행 도중에 상해로 약관에 정한 골절을 입고 그 치료를 직접적인 목적으로 수술을 받은 경우 보험가입금액 지급. 단, 하나의 사고로 두 종류 이상의 골절수술을 받은 경우에는 하나의 골절수술비 보험금만 지급
						</td>
					</tr>
					<tr>
						<td>국내여행 상해수술비 (동일사고당 1회한)</td>
						<td class="txt-L">
							국내여행 도중에 상해의 직접결과로써 수술을 받은 경우 보험가입금액 지급. 단, 하나의 사고로 두 종류 이상의 상해수술을 받은 경우에는 하나의 상해수술비 보험금만 지급
						</td>
					</tr>
					<tr>
						<td>국내여행 깁스치료비 (동일사고 또는 질병당 1회한)</td>
						<td class="txt-L">
							국내여행 도중에 상해 또는 질병으로 인하여 깁스(Cast)치료(단, 부목치료는 제외)를 받은 경우 매 사고마다 보험가입금액 지급. 단, 동일한 상해 또는 질병으로 인하여 깁스치료를 2회 이상 받은 경우, 또는 동시에 서로 다른 신체부위에 깁스치료를 받은 경우에는 1회에 한하여 깁스치료비 보험금을 지급
						</td>
					</tr>
				</tbody>
			</table>
        ...
        <div class="inner" style="min-height:800px;">
			...
			<div class="common-type">
				<ul class="row-bor">
					...
					<li>기존 보험계약을 해지하고 새로운 보험계약을 체결하는 경우 보험인수가 거절되거나, 보험료가 인상 될 수 있으며, 보장내용(면책기간 재적용 등)이 달라질 수 있으니 유의하시기 바랍니다.</li>
			...
			<div class="common-type">
				<p class="sub_ttl">보상하지 아니하는 손해</p>
				<ul class="row-numlist">
					<li>1. 피보험자의 고의, 보험수익자의 고의, 계약자의 고의, 피보험자의 임신, 출산(제왕절개를 포함), 산후기, 전쟁, 외국의 무력행사, 혁명, 내란, 사변, 폭동</li>
					<li>2. 전문등반, 글라이더 조종, 스카이다이빙, 스쿠버다이빙, 행글라이딩, 수상보트, 패러글라이딩</li>
					<li>3. 모터보트, 자동차 또는 오토바이에 의한, 경기, 시범, 흥행(이를 위한 연습을 포함) 또는 시운전</li>
					<li>4. 선박에 탑승하는 것을 직무로 하는 사람이 직무상 선박에 탑승하고 있는 동안</li>
				</ul>
			</div>
			...
			<div class="common-type">
				...
				<ul class="row-bor">
					<li>이 보험계약은 예금자보호법에 따라 예금보험공사가 보호하되, 보호 한도는 본 보험회사에 있는 귀하의 모든 예금보호 대상 금융상품의 해약환급금(또는 만기 시 보험금이나 사고보험금)에 기타지급금을 합하여 1인당 “최고 5천만원”이며, 5천만원을 초과하는 나머지 금액은 보호하지 않습니다. 다만, 보험계약자 및 보험료 납부자가 법인인 보험계약은 예금자보호법에 따라 예금보험공사가 보호하지 않습니다.</li>
				</ul>
			</div>
